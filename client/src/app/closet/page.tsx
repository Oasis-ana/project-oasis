...
export default function ClosetPage() {
  ...
  const getCatalogItems = () => [
    { id: 'c1', name: ' Button-Down Shirt', category: 'Tops', description: 'Classic collared button-up', commonBrands: ['Uniqlo', 'J.Crew'] },
    { id: 'c2', name: 'Black Shirt', category: 'Tops', description: 'Basic crew neck tee', commonBrands: ['Hanes', 'Uniqlo'] },
    { id: 'c3', name: 'White Shirt', category: 'Tops', description: 'Basic white tee', commonBrands: ['Hanes', 'Uniqlo'] },
    { id: 'c4', name: 'Long-Sleeve Shirt', category: 'Tops', description: 'Navy/white stripes', commonBrands: ['J.Crew', 'Madewell'] },
    { id: 'c5', name: ' Sweater', category: 'Tops', description: 'Soft pullover sweater', commonBrands: ['Uniqlo', 'Everlane'] },
    { id: 'c6', name: 'Cardigan', category: 'Tops', description: 'Button-up sweater', commonBrands: ['J.Crew', 'Madewell'] },
    { id: 'c7', name: 'Jeans', category: 'Bottoms', description: 'Classic blue denim', commonBrands: ['Levi\'s', 'Madewell'] },
    { id: 'c8', name: 'Trousers', category: 'Bottoms', description: 'Faded blue denim', commonBrands: ['Levi\'s', 'American Eagle'] },
    ...
    { id: 'c11', name: 'Mini Dress', category: 'Dresses', description: 'Classic cocktail dress', commonBrands: ['Zara', 'Banana Republic'] },
    { id: 'c12', name: 'Maxi Dress', category: 'Dresses', description: 'Flattering wrap-style', commonBrands: ['DVF', 'J.Crew'] },
    { id: 'c13', name: 'Midi Dress', category: 'Dresses', description: 'Long flowing dress', commonBrands: ['Free People', 'Anthropologie'] },
    { id: 'c14', name: 'Denim Jacket', category: 'Outerwear', description: 'Classic jean jacket', commonBrands: ['Levi\'s', 'Madewell'] },
    { id: 'c15', name: 'Blazer', category: 'Outerwear', description: 'Professional jacket', commonBrands: ['Zara', 'Banana Republic'] },
    { id: 'c16', name: 'Jacket', category: 'Outerwear', description: 'Edgy moto jacket', commonBrands: ['AllSaints', 'Madewell'] },
    { id: 'c17', name: 'Sneakers', category: 'Shoes', description: 'Classic tennis shoes', commonBrands: ['Adidas', 'Nike'] },
    { id: 'c18', name: 'Heels', category: 'Shoes', description: 'Professional pumps', commonBrands: ['Cole Haan', 'Nine West'] },
    { id: 'c19', name: 'Ballet Flats', category: 'Shoes', description: 'Comfortable flat shoes', commonBrands: ['Tory Burch', 'Cole Haan'] },
    { id: 'c20', name: ' Belt', category: 'Accessories', description: 'Classic leather belt', commonBrands: ['Coach', 'Kate Spade'] },
