    ...
    <>
      <div className="fixed left-0 top-0 h-screen w-20 bg-[#0B2C21] flex flex-col items-center py-8 z-10">
        ...
        <div className="flex flex-col items-center flex-1">
          {/* Home Icon */}
          <div
            className="flex items-center justify-center mb-14 cursor-pointer hover:opacity-75 transition-opacity"
          ...
          >
            <img
              src={pathname === '/closet' ? "/filled-in-hanger.png" : "/hanger-for-sidebar.png?v=2"}
              alt="Hanger"
              ...
              style={{
                ...
                width: '32px',
                height: '32px',
                opacity: pathname === '/closet' ? 1 : 0.75
              }}
            />
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-lg p-6 w-96 shadow-xl border border-white/20">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B2C21] hover:bg-gray-50 transition-colors"
              >
                <div className="w-12 h-12 bg-[#0B2C21] rounded-full flex items-center justify-center mb-3">
                  <Camera className="w-6 h-6 text-white" />
                </div>
                <span className="text-sm font-medium text-gray-800" style={{ fontFamily: 'Playfair Display, serif' }}>
                  Log Today's Look
                </span>
                <span className="text-xs text-gray-500 mt-1 text-center" style={{ fontFamily: 'Inter' }}>
                  Share your outfit
                </span>
              </button>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={itemData.size}
                          onChange={(e) => handleItemInputChange('size', e.target.value)}
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900"
                          placeholder="e.g., M"
                          style={{ fontFamily: 'Inter' }}
                        />
