...
import { Home, Camera, Bell, Settings, X, Upload, Sun, Moon, Cloud, CloudSun, CloudRain, CloudSnow, CloudLightning, LoaderCircle, CloudDrizzle, Wind, Menu } from 'lucide-react'
...
const Sidebar = ({ user, onShowSettings }: SidebarProps) => {
  ...
  const renderWeatherIcon = () => {
    ...
    if (error || !weather) {
      return <Bell className="w-5 h-5 lg:w-6 lg:h-6 text-white" />;
    }
  ...
  const navigationItems = [
    {
      icon: <Home className={`w-5 h-5 lg:w-6 lg:h-6 text-white ${(pathname === '/home' || pathname === '/homepage' || pathname === '/') ? 'fill-current' : ''}`} />,
      onClick: () => { router.push('/home'); setIsMobileMenuOpen(false); },
      label: 'Home'
    },
    {
      icon: <img src={pathname === '/closet' ? "/filled-in-hanger.png" : "/hanger-for-sidebar.png?v=2"} alt="Hanger" className="object-contain" style={{ filter: 'brightness(0) invert(1)', width: '20px', height: '20px', opacity: pathname === '/closet' ? 1 : 0.75 }}/>,
      onClick: () => { router.push('/closet'); setIsMobileMenuOpen(false); },
      label: 'Closet'
    },
    {
      icon: <Camera className="w-5 h-5 lg:w-6 lg:h-6 text-white" />,
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden lg:flex fixed left-0 top-0 h-screen w-20 bg-[#0B2C21] flex-col items-center py-8 z-10">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#0B2C21] border-t border-[#0B2C21]/20 z-40">
        <div className="flex items-center justify-around py-2 px-4 safe-area-pb">
          ...
          >
            ...
            <span className="text-xs text-white/80">Weather</span>
          </button>
      ...
      {/* Choice Modal - Mobile Optimized */}
      {showChoiceModal && (
        <div className="fixed inset-0 backdrop-blur-md bg-black/20 flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-md rounded-lg w-full max-w-md shadow-xl border border-white/20">
            <div className="p-4 lg:p-6">
              <h3 className="text-lg lg:text-xl font-semibold text-gray-800 mb-3 lg:mb-4 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
                What would you like to add?
              </h3>
              <p className="text-gray-600 mb-4 lg:mb-6 text-center text-sm" style={{ fontFamily: 'Inter' }}>
                Choose what you want to create
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button 
                  onClick={() => handleChoiceSelection('outfit')} 
                  className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B2C21] hover:bg-gray-50 transition-colors active:scale-95 touch-manipulation"
                >
                  <div className="w-12 h-12 bg-[#0B2C21] rounded-full flex items-center justify-center mb-3">
                    <Camera className="w-6 h-6 text-white" />
                  </div>
                  <span className="text-sm font-medium text-gray-800 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>Log Today's Look</span>
                  <span className="text-xs text-gray-500 mt-1 text-center" style={{ fontFamily: 'Inter' }}>Share your outfit</span>
                </button>
                <button 
                  onClick={() => handleChoiceSelection('item')} 
                  className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B2C21] hover:bg-gray-50 transition-colors active:scale-95 touch-manipulation"
                >
                  ...
                  <span className="text-sm font-medium text-gray-800 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>Add Item</span>
              ...
              <div className="mt-4 lg:mt-6 flex justify-center">
                <button 
                  ...
                  className="px-6 py-2 text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 active:bg-gray-200 transition-colors touch-manipulation" 
        ...
        <div className="fixed inset-0 backdrop-blur-md bg-white/20 flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-md rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl border border-white/20">
            <div className="flex items-center justify-between p-4 lg:p-6 border-b border-gray-200">
              <h3 className="text-lg lg:text-xl font-semibold text-[#0B2C21]" style={{ fontFamily: 'Playfair Display, serif' }}>Log Today's Look</h3>
              <button 
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button 
                      ...
                      className="flex flex-col items-center justify-center p-6 lg:p-8 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B2C21] hover:bg-gray-50 active:bg-gray-50 transition-colors touch-manipulation"
                    >
                ...
                <div className="space-y-6">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-6 space-y-4 sm:space-y-0">
                    <div className="relative flex-shrink-0 mx-auto sm:mx-0">
                      ...
                      <button 
                        ...
                        className="absolute top-2 right-2 p-2 bg-red-500 text-white rounded-full hover:bg-red-600 active:bg-red-600 transition-colors touch-manipulation"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                    <div className="flex flex-col space-y-3">
                      <button 
                        onClick={() => setShowCameraModal(true)} 
                        className="px-4 py-3 text-sm text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 active:bg-gray-200 transition-colors touch-manipulation" 
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    <div>
                      ...
                      <input 
                        ...
                        onChange={(e) => handleOutfitInputChange('title', e.target.value)} 
                        className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm" 
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        onChange={(e) => handleOutfitInputChange('description', e.target.value)} 
                        rows={3} 
                        className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm resize-none" 
                    ...
                    <div>
                      ...
                      <select 
                        ...
                        onChange={(e) => handleOutfitInputChange('category', e.target.value)} 
                        className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm" 
                        style={{ fontFamily: 'Inter' }}
                      >
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        onChange={(e) => handleOutfitInputChange('tags', e.target.value)} 
                        className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm" 
                  ...
                  <div className="flex justify-end mt-6 lg:mt-8">
                    <button 
                      ...
                      className={`px-6 py-3 rounded-full font-medium text-sm transition-all touch-manipulation min-h-[48px] ${
                        isUploading || !selectedImage || !outfitData.title ? 'bg-gray-400 text-white cursor-not-allowed' : 'bg-[#0B2C21] text-white hover:opacity-90 active:scale-95'
                      }`} 
                      style={{ fontFamily: 'Inter' }}
                    >
      ...
      {showAddItemModal && (
        <div className="fixed inset-0 backdrop-blur-md bg-white/20 flex items-center justify-center z-50 p-4">
          <div className="bg-white/95 backdrop-blur-md rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl border border-white/20">
            <div className="flex items-center justify-between p-4 lg:p-6 border-b border-gray-200">
              <h3 className="text-lg lg:text-xl font-semibold text-[#0B2C21]" style={{ fontFamily: 'Playfair Display, serif' }}>Add Item to Closet</h3>
              <button 
            ...
            <div className="p-4 lg:p-6">
              {!selectedImage ? (
                <div className="mb-6">
                  <h4 className="text-base lg:text-lg font-medium text-[#0B2C21] mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Add Item Photo</h4>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button 
                      onClick={() => setShowCameraModal(true)} 
                      className="flex flex-col items-center justify-center p-6 lg:p-8 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0B2C21] hover:bg-gray-50 active:bg-gray-50 transition-colors touch-manipulation"
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 lg:space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input 
                          ...
                          onChange={(e) => handleItemInputChange('color', e.target.value)} 
                          className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm" 
                    ...
                    <div>
                      ...
                      <input 
                        type="text" 
                        value={itemData.tags} 
                        onChange={(e) => handleItemInputChange('tags', e.target.value)} 
                        className="w-full px-4 py-3 lg:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0B2C21] text-gray-900 text-base lg:text-sm" 
                        placeholder="e.g., casual, work, winter" 
                        style={{ fontFamily: 'Inter' }} 
                      />
                  ...
                  <div className="flex justify-end mt-6 lg:mt-8">
                    <button 
                      ...
                      className={`px-6 py-3 rounded-full font-medium text-sm transition-all touch-manipulation min-h-[48px] ${
                        isUploading || !selectedImage || !itemData.name ? 'bg-gray-400 text-white cursor-not-allowed' : 'bg-[#0B2C21] text-white hover:opacity-90 active:scale-95'
                      }`} 
                      style={{ fontFamily: 'Inter' }}
                    >
